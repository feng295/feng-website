        ...
        try {
            ...
            spots.forEach(spot => {
                ...
                <td class="border px-4 py-2 text-center space-x-1">
                    <button class="edit-btn bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 rounded inline-flex items-center gap-1"
                    ...
                    <button class="delete-btn bg-red-600 hover:bg-red-700 text-white text-xs px-3 py-1 rounded inline-flex items-center gap-1"
                            data-id="${spot.parking_lot_id}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
