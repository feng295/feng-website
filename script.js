        ...
        try {
            ...
            spots.forEach(spot => {
                ...
                <td class="border px-4 py-2 text-center space-x-1">
                    <button class="edit-btn bg-blue-600 hover:bg-blue-700 text-white text-xs px-2.5 py-1 rounded inline-flex items-center gap-1 transition-colors"
                            data-id="${spot.parking_lot_id}">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                        </svg>
                        編輯
                    </button>
                    <button class="delete-btn bg-red-600 hover:bg-red-700 text-white text-xs px-2.5 py-1 rounded inline-flex items-center gap-1 transition-colors"
                            data-id="${spot.parking_lot_id}">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
